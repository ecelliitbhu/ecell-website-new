...
export default function CampusAmbassadorProgram() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
      ...
      <div 
        style={{ 
          background: 'linear-gradient(135deg, #FF6B6B, #FFCD6E)', 
          flexGrow: 1, 
          padding: '100px 0',
          display: 'flex',
            ...
            <div className={"form-card-content"}>
              <div className="text-center mb-4">
                <h1 className="fw-bold" style={{ 
                  ...
                  Join Campus Ambassador's Program
                </h1>
              </div>
              <Form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className={"email"}>
                  <Form.Group className="mb-3" controlId="email">
                    <Form.Label>
                      Email address(Please enter the email you want the updates
                ...
                <Form.Group className="mb-3" controlId="PoR">
                  ...
                  <Form.Group className="mb-3" controlId="Role">
                    <Form.Label>
                      Have you been a part of any Student Body or Organizations ?
                      Please mention your role .<span style={{ color: "red" }}> *</span>
                    </Form.Label>
                    <Form.Control
                      as="textarea"
                  ...
                  <Form.Group className="mb-3 flex flex-col" controlId="skills">
                    <Form.Label>
                      What Skills do you think you can contribute in the Campus
                      Ambassador Program? <span style={{ color: "red" }}>*</span>
                    </Form.Label>
                        ...
                        <input
                          ...
                          onChange={(e) => {
                            ...
                            if (e.target.checked) {
                              ...
                              setSelectedSkills(
                                selectedSkills.filter((skill) => skill !== "Other Skills")
                              );
                            }
                          }}
                        />
                  ...
                  <Form.Group className="mb-3" controlId="PreviousAssociation">
                    <Form.Label>
                      Any Previous Association with E-Cell IIT BHU? If yes, please
                  ...
                  <Form.Group className="mb-3" controlId="otherPoints">
                    <Form.Label>
                      ...
                      motivation to join the Campus Ambassador Program ?
                      <span style={{ color: "red" }}> *</span>
                    </Form.Label>
                    <Form.Control
                      as="textarea"
