      ...
      <Container fluid className="body">
        ...
        >
          ...
          >
            ...
            >
              <Link href="https://www.instagram.com/ecelliitbhu/" passHref legacyBehavior>
                <FaInstagram
              ...
              <Link href="https://www.facebook.com/ecelliitvaranasi" passHref legacyBehavior>
                <FaFacebook
                  className="social-icons"
                  style={
                    {
              ...
              <Link href="https://discord.com/invite/EPm5mfbCKP" passHref legacyBehavior>
                <FaDiscord
                  className="social-icons"
                  style={
                    {
