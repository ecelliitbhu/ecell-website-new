...
const PostInternshipPage = () => {
  ...
  return (
    <>
      <Head>
        <title>Post New Internship - IIT BHU Portal</title>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-[#f56a38] focus:border-transparent ${
                        errors.companyName
                          ? "border-red-500"
                          : "border-gray-300"
                      }`}
                  ...
                  <button
                    ...
                    className={`px-6 py-3 rounded-lg font-medium text-white transition-colors ${
                      isSubmitting
                        ...
                        : "bg-[#f56a38] hover:bg-[#e55a32] focus:outline-none focus:ring-2 focus:ring-[#f56a38] focus:ring-offset-2"
                    }`}
                  >
