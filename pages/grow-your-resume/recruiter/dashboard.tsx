                        ...
                        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                            <div className="flex justify-between items-center py-4">
                                ...
                                <div className="flex items-center space-x-4">
                                    <span className="text-sm">Welcome, {currentRecruiter?.companyName || "Recruiter"}</span>
                                    <Link href="/grow-your-resume/recruiter/dashboard" className="px-4 py-2 bg-white text-black rounded font-medium hover:bg-gray-100 transition-colors">
                                        Dashboard
                                    </Link>
                                    <Link href="/grow-your-resume/recruiter/profile" className="px-4 py-2 text-black hover:bg-[#f56a38] hover:text-white rounded transition-colors">
                                        Profile
                                    </Link>
                    ...
                    <main className="flex items-center justify-center py-20 px-4 text-center">
                        <div className="max-w-md">
                            ...
                            <p className="text-gray-600 mb-4">
                                Wait till we verify your registration. If it is taking more than 2 business days, please contact{" "}
                                <a href="mailto:ecell@itbhu.ac.in" className="text-[#f56a38] underline">
                                    ecell@itbhu.ac.in
                                </a>
                                .
                            </p>
                ...
                <div className="bg-white min-h-screen">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                        ...
                        <div className="flex justify-between items-center mb-8">
                            ...
                            <Link href="/grow-your-resume/recruiter/post-internship" className="inline-flex items-center px-6 py-3 bg-[#f56a38] text-white rounded-lg hover:bg-[#e55a32] focus:outline-none focus:ring-2 focus:ring-[#f56a38] focus:ring-offset-2 transition-colors">
                            ...
                            <div className="space-y-6">
                                {postings.length === 0 ? (
                                    <div className="bg-white border border-gray-200 rounded-lg p-12 text-center">
                                        ...
                                        <Link href="/grow-your-resume/recruiter/post-internship" className="inline-flex items-center px-6 py-3 bg-[#f56a38] text-white rounded-lg hover:bg-[#e55a32] transition-colors">
                                            <Plus className="w-5 h-5 mr-2" />
                                            Post New Internship
                                        </Link>
                                    </div>
                                            ...
                                            <div className="flex justify-between items-start">
                                                <div className="flex-1">
                                                    ...
                                                    <div className="text-sm text-gray-600 mb-4">
                                                        <p className="mb-1">
                                                            <span className="font-medium">Company:</span> {posting.companyName}
                                                        </p>
                                                        <p className="mb-1">
                                                            <span className="font-medium">Location:</span> {posting.location}
                                                        </p>
                                                        <p className="mb-1">
                                                            <span className="font-medium">Type:</span> {posting.jobType}
                                                        </p>
                                                        <p className="mb-1">
                                                            <span className="font-medium">Stipend:</span> {posting.stipend}
                                                        </p>
                                                    </div>
                                                ...
                                                <div className="ml-6 flex flex-col space-y-2">
                                                    ...
                                                    <button onClick={() => handleDeletePosting(posting.id)} className="inline-flex items-center px-4 py-2 border border-red-300 text-red-600 rounded-lg hover:bg-red-50 transition-colors">
                        ...
                        {activeTab === "applications" && (
                            <div>
                                {selectedPosting && (
                                    <div className="mb-6">
                                        <h3 className="text-xl font-bold text-gray-900 mb-2">Applications for {selectedPosting.jobTitle}</h3>
                                        <button onClick={() => setSelectedPosting(null)} className="text-[#f56a38] hover:text-[#e55a32] text-sm">
                                                ...
                                                {getFilteredApplications().map((application) => (
                                                    <tr key={application.id} className="hover:bg-gray-50">
                                                        ...
                                                        <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                                            <button onClick={() => handleViewStudent(application.student)} className="text-blue-600 hover:text-blue-800 underline">
                                                                {application.student.name}
                                                            </button>
                                                        </td>
                                                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{application.student.rollNo}</td>
                                                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{application.student.branch}</td>
                                                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{application.student.cpi}</td>
                                                        <td className="px-6 py-4 whitespace-nowrap text-sm text-blue-600">
                                                            {application.student.resumeUrl ? (
                                                                <a href={application.student.resumeUrl} target="_blank" rel="noopener noreferrer" className="hover:text-blue-800 flex items-center">
                                                                    View Resume
                                                        ...
                                                        <td className="px-6 py-4 whitespace-nowrap">
                                                            <span
                                                                className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${application.status === "PENDING" ? "bg-yellow-100 text-yellow-800" : application.status === "ACCEPTED" ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"
                                                                    }`}
                                                            >
                                                                {application.status}
                                                            </span>
                                                        ...
                                                        <td className="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                                            {application.status?.toUpperCase() === "PENDING" && (
                                                                <>
                                                                    <button onClick={() => handleApplicationAction(application.id, "ACCEPTED")} className="px-3 py-1 bg-green-500 text-white rounded hover:bg-green-600 transition-colors">
                                                                        Accept
                                                                    </button>
                                                                    <button onClick={() => handleApplicationAction(application.id, "REJECTED")} className="px-3 py-1 bg-red-500 text-white rounded hover:bg-red-600 transition-colors">
                                                                        Reject
                                                                    </button>
                                                                </>
                                                            )}
                        ...
                        <div className="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
                            <div className="p-6">
                                ...
                                <div className="space-y-4">
                                    <div className="grid grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-gray-900">{selectedStudent.courseType}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="space-y-4">
                                        <div>
                                            ...
                                            {selectedStudent.linkedinUrl ? (
                                                <a href={selectedStudent.linkedinUrl} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 flex items-center">
                                                    {selectedStudent.linkedinUrl}
                                                    <ExternalLink className="w-3 h-3 ml-1" />
                                                </a>
                                            ) : (
                                        ...
                                        <div>
                                            ...
                                            {selectedStudent.githubUrl ? (
                                                <a href={selectedStudent.githubUrl} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 flex items-center">
                                                    {selectedStudent.githubUrl}
                                                    <ExternalLink className="w-3 h-3 ml-1" />
                                                </a>
                                            ) : (
                                        ...
                                        <div>
                                            ...
                                            {selectedStudent.resumeUrl ? (
                                                <a href={selectedStudent.resumeUrl} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 flex items-center">
                                                    View Resume
                                                    <ExternalLink className="w-3 h-3 ml-1" />
                                                </a>
                                            ) : (
                                ...
                                <div className="mt-6 flex justify-end">
                                    <button onClick={() => setShowStudentModal(false)} className="px-4 py-2 bg-gray-300 text-gray-700 rounded-lg hover:bg-gray-400 transition-colors">
                                        Close
                                    </button>
                                </div>
                            </div>
                ...
                {isEditing && editingPosting && (
                    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
                        <div className="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
                            <div className="p-6">
                                <div className="flex justify-between items-center mb-6">
                                    <h3 className="text-2xl font-bold text-gray-900">Edit Posting</h3>
                                    ...
                                    onSubmit={async (e) => {
                                        ...
                                        try {
                                            await postsAPI.update(editingPosting.id, {
                                                ...
                                                jobTitle: editingPosting.jobTitle,
                                                jobDescription: editingPosting.jobDescription,
                                                qualification: editingPosting.qualification,
                                                experience: editingPosting.experience,
                                                stipend: editingPosting.stipend,
                                                requiredSkills: editingPosting.requiredSkills,
                                                location: editingPosting.location,
                                                jobType: editingPosting.jobType?.toUpperCase(),
                                            });
                                ...
                                >
                                    ...
                                    <div>
                                        ...
                                        <textarea
                                            rows={4}
                                            value={editingPosting.jobDescription}
                                            onChange={(e) =>
                                                setEditingPosting({
                                                    ...editingPosting,
                                    ...
                                    <div>
                                        ...
                                        <input
                                            type="text"
                                            value={editingPosting.requiredSkills}
                                            onChange={(e) =>
                                                setEditingPosting({
                                                    ...editingPosting,
                                    ...
                                    <div className="flex justify-end space-x-4 pt-4">
                                        <button type="button" onClick={() => setIsEditing(false)} className="px-4 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors">
                                            Cancel
                                        </button>
                                        <button type="submit" className="px-4 py-2 bg-[#f56a38] text-white rounded-lg hover:bg-[#e55a32] transition-colors">
                                            Save Changes
                                        </button>
                                    </div>
                                </form>
