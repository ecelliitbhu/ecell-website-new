...
import StartBucksRound2 from "../../../components/events/submission/round1/StartBucksRound2";
export default function StartBucksRound2Submission() {
  return (
    <>
      <Head>
      ...
      <div>
        <Container fluid className="body">
          ...
          >
            ...
            >
              Start-Bucks Pitch Deck Submission
            </h1>
          </Row>
          {/* <Row
